...
const inFunctions = {
  ...
  isInObject(element, values) {
    ...
    return values.every(value =>
      (new RegExp(`"${value}":`)).test(parsedElement)
    );
  },
};
 ...
 * @return {Boolean} - if you pass more than one value, it will check that actually all the
 ...
 * @param {Number} size What should be the length of the Object or the Array.
 * @return {Boolean}
 */
 ...
 * @return {String} The joined classes. Eg.'px-0 border-0'
 */
...
// export const updateStoreAction = (module, subModule, action, id) =>
//   controls =>
//     () => {
//       action(module, id, subModule, controls);
//     };
...
//  * @param {function} content
//  */
// export const hasNotValue = value =>
...
//  * @return Boolean
//  */
// export const hasSomeValue = (element, values) =>
...
// /**
//  * It will check if the given run is correct.
//  * 
//  * @param {String} value The given R.U.N.
//  * @returns Boolean
//  */
// export const isRUN = value => {
//   const text = (typeof value === 'string' ? value : value.target.value).toLowerCase().trim().replace(/[\.-]/g, '');
