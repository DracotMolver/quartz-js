...
// describe('A suit validations functions', () => {
...
//       const string = 'hellow world'; // 12

//       it('Is `exactSize` the specified amount of elements', () => {
...
//       it('Is `moreOrEqual` than the given value', () => {
...
//       it('Is `lessOrEqual` than the given value', () => {
